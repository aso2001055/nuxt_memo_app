<template>
    <section class="container">
        ...
        <table>
            ...
            <tr>
                <th>Memo</th>
                <td><textarea name="content" class="content" cols="30" rows="10"></textarea></td></tr>
            <tr><th></th>
            <td>
        ...
        <hr>
        <ul class="list">
            <li v-for="item in page_items" v-bind:key="item.indexOf">
            ...
            if(this.find_flg) {
                ...
                data.forEach(element => {
                    if(element.title.toLowerCase().indexOf(
                        this.title.toLocaleLowerCase()) > 0) {
                            arr.push(element);
                        }
                });
                return arr;
